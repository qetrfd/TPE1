  ...
  return (
    <div className="talent-panel relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#090d14] p-6 shadow-2xl shadow-black/25 sm:p-10 lg:p-12">
      ...
      <div className="relative grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
        <StaggerContainer className="flex flex-col justify-between" stagger={0.13}>
          <StaggerItem>
        ...
        <StaggerContainer className="engineering-grid grid content-start gap-3 sm:grid-cols-2" stagger={0.08}>
          {disciplines.map(({ title, area, Icon }, index) => (
            <StaggerItem key={title}>
              <article className="engineering-card group">
      ...
      <FadeIn className="talent-car-visual" delay={0.12}>
